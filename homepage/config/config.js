var config = {
    ...
    */  
    ...
    skills_description: "<ul>" +
        "     <li>掌握数据结构与算法，计算机网络。</li>" +
        "     <li>熟练掌握Java基础，熟悉JavaIO、多线程、集合、注解、反射等基础机制。</li>" +
        "     <li>了解JVM原理与调优方法。</li>" +
        "     <li>熟悉SQL语句编写以及调优。</li>" +
        "     <li>熟悉基本Linux命令操作与项目部署。</li>" +
        "     <li>熟悉Springmvc，了解其原理与机制。</li>" +
        "     <li>熟悉redis缓存、消息等机制。</li>" +
        "     <li>了解分布式系统与大数据组件的应用。</li>" +
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "http://1.15.234.109:8000/", "个人博客", "这里记录了我的技术学习笔记<br>持续更新"],
        ["./images/pro-2.png", "https://github.com/happysnaker/Gobang", "api开放平台", "spring项目，包含用户登陆注册与开放api调用服务，包含gpt对话式数据分析<br>2021/7/23"],
        ["https://pic3.zhimg.com/80/v2-d9766956d5c85c2780e4c5008fd946ca_1440w.jpg", "https://github.com/happysnaker/StudentsManageSystem", "离线数仓系统", "大数据组件与数仓建模实践"]
    ],
     ...
     */
    others: [
        ["2018-09~2022-06", "天津工业大学","数据科学与技术"],
        ["2022-09~2025", "南京邮电大学","数学与应用数学"],
    ],
